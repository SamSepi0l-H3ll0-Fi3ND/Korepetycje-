        ...
        <div>
            <div class = "min-h-screen w-screen">
                ...
                <div class="bg-[#a0bdcf] w-screen">
                    <div>
                        <p class="text-3xl text-[#06283d] flex justify-center pt-16">Przeglądaj korepetytorów...</p>
                        ...
                        <div class="flex justify-center">
                            <div class="max-w-xl">
                                ...
                                <div class="flex flex-col justify-center pb-10">
                                    <p class="text-[#06283d] text-center pb-2">Cena(zł) <span id="price">{inputValue}</span></p>
                                    <input type="range" onChange={(e) => setInputValue(e.target.value)} min="1" max="1000" id="slider" class="range range-primary bg-[#7c6fde]"></input>
                                </div>
                            </div>
                        </div>
                    </div>
