...
const Ad = (props) => {
    ...
    return(
        <div class="h-auto bg-[#d0dfe9] rounded-md w-auto shadow-[0_0_16px_0_rgba(0,0,0,0.5)] text-dark-blue m-3" id={`Ad${adData.id}`}>
            <div class="flex sm:flex-row">
                ...
                <div class="flex flex-col basis-9/12">
                    ...
                    <div class="flex justify-left p-6">
                ...
                <div class="flex flex-col m-4 basis-2/12">
                    <div class="flex flex-col mt-2">
                        <div class="flex justify-center m-2">
                            <MonetizationOnIcon/> {adData.price}zł / {adData.lessonLength} minut
                        </div>
                        <div class="flex justify-center m-2">
